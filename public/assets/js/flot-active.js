(function ($) {
    ...
    for (var data = [], totalPoints = 100,
             d1 = [], i = 0; 10 >= i; i += 1) d1.push([i, parseInt(30 * Math.random())]);
    ...
    $("#line-chart")[0] && $.plot($("#line-chart"), [{
        ...
        if (item) {
            var x = item.datapoint[0].toFixed(50),
   ...
   ------------------------------ */
    ...
    for (var d1 = [], i = 0; 10 >= i; i += 1) d1.push([i, parseInt(10 * Math.random())]);
    for (var d2 = [], i = 0; 20 >= i; i += 1) d2.push([i, parseInt(10 * Math.random())]);
    for (var d3 = [], i = 0; 10 >= i; i += 1) d3.push([i, parseInt(10 * Math.random())]);
    var options = {
        series: {
            shadowSize: 0,
            curvedLines: {
